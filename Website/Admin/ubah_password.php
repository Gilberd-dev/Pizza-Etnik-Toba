  ...
  <body>
    ...
    <div class="popup">
      ...
      <div class="icon" style="margin-left:100px;">
        ...
        <div class="note">
          <label class="title">Ubah Password</label>
          <?php if(!isset($error)) : ?>
          <span class="subtitle">Masukkan Password untuk Memverifikasi bahwa Anda adalah Admin.</span>
          <?php endif; ?>
          <?php if(isset($error)) : ?>
                        <p style="color:red;position: relative;margin: 2px 0;width: 310px;">Password Tidak Sesuai</p>
                    <?php endif; ?>
        </div>
        <input placeholder="Masukkan Password anda" name="password" type="password" class="input_field">
        <button class="submit" type="submit" name ="check-password">Lanjutkan</button>
      </form>
    </div>
