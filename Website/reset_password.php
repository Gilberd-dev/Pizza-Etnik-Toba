  ...
  <body>
    ...
    <div class="popup">
      ...
      <div class="icon" style="margin-left:100px;">
        ...
        <div class="note">
          <label class="title">Password Baru</label>
          <?php if(isset($error)) : ?>
                        <p style="color:red;position: relative;margin: 2px 0;width: 310px;">Konfirmasi password tidak cocok</p>
                    <?php endif; ?>
        </div>
        <input placeholder="Masukkan Password Baru" name="password_baru" type="password" class="input_field">
        <input placeholder="Konfirmasi Password" name="password_konfirmasi" type="password" class="input_field">
        <button class="submit" type="submit" name = "change-password">Simpan</button>
      </form>
    </div>
