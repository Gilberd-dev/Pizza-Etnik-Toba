  ...
  <body>
    ...
    <div class="popup">
      ...
      <div class="icon" style="margin-left:100px;">
        ...
        <div class="note">
          <label class="title">Verifikasi Kode</label>
          <?php if(isset($error)) : ?>
          <p style="color:red;position: relative;margin: 2px 0;width: 310px;">Kode yang Anda masukkan salah</p>
          <?php endif; if(isset($info) && !isset ($error)) : 
          ...
          <span class="subtitle">Kode verifikasi telah dikirimkan ke Email Anda yaitu <b><?php echo $kategori['email_admin'];?></b></span>
          <?php endif; ?>
        </div>
        <input placeholder="Masukkan Kode Verifikasi" name="otp" type="number" class="input_field">
        <button class="submit" type="submit" name = "verifikasi">Verifikasi</button>
      </form>
    </div>
